...
public class ProdutosController {
    ...
    @PostMapping
    public ResponseEntity<ProdutoResponse>cadastrar(@Valid @RequestBody Produtos prod){
        Produtos novoProduto = service.cadastrar(prod);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProdutoResponse>putProdutos(@PathVariable Integer id, @RequestBody Produtos produtoAtt){
