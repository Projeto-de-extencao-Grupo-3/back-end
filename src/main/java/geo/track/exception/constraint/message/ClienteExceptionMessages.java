...
public class ClienteExceptionMessages {
    ...
    public static final String CLIENTE_NAO_ENCONTRADO_NOME = "O nome %s não foi encontrado para esta oficina";
    public static final String CLIENTE_NAO_ENCONTRADO_CPF_CNPJ = "CPF %s não foi encontrado para esta oficina";
